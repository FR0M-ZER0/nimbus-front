...
function Modal({ onClose, children }) {
    return (
        <div className='min-w-screen min-h-screen bg-black/75 fixed z-100 top-0 left-0' onClick={onClose}>
            <div className='min-h-[700px] max-w-[1200px] fixed top-1/2 left-1/2 -translate-1/2 alt-dark-color-bg z-101 h-[700px] w-[1200px] p-12 pb-22 rounded-lg' onClick={e => e.stopPropagation()}>
